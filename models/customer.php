...
class Customer implements iCustomer {
    ...
    public function addCustomer($conn) {
        ...
        LoggerMessages::catchError($result, "addCustomer function success", "problem with adding customer to database");
        return true;
    }
    ...
    public function updateCustomer($conn) {
        ...
        $result = $conn->connectData($sql);
        LoggerMessages::catchError($result, "updateCustomer function success", "problem with update customer to database"); // Logger
        return true;
    }
    ...
    public function tableData() {
        ...
        "<tr>
            ...
            <td>" . ucwords($this->Password) . "</td>
            <td>" . ucwords($this->IdentityCard) . "</td>
            <td><button class='btn btn-danger text-center' name='deleteCustomer' value='$this->Id'><i class='fa fa-trash'></i></button></td>
            <td class='icon-edit'><img src='../images/icons/edit.png'></td>
        </tr>
        <tr class='tr-edit'>
            ...
            <td class='cancel-edit'><img src='../images/icons/cancel.png'></td>
            <td><input type='image' src='../images/icons/save.png' name='saveCustomer' value='$this->Id'></td>
        </tr>";
    }
